...
class Node {
    private:
        ...
        string info_="N/A"; //info related to the node (such as the labels in tourism.csv)
        pair<double,double> coordinates_={0,0};
    ...
    public:
        ...
        */
        Node(int index, string info="N/A", pair<double,double> coordinates={0,0}) {
            index_=index;
            info_=info;
